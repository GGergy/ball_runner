...
def main():
    ...
    def restart():
        ...
        ball_img = pygame.image.load('texture.png')
    ...
    def pr_text(txt, scr, cord=(320, 240), n=20, color=(255, 255, 255)):
    ...
    pygame.draw.rect(screen, BLACK, (0, 0, screen_width, screen_height))
    pr_text('SPACE to jump', cord=(screen_width // 2 - 50, screen_height // 2 - 50), n=30, scr=screen)
    pygame.display.update()
    sleep(0.5)

    pygame.draw.rect(screen, BLACK, (0, 0, screen_width, screen_height))
    pr_text('Q to faster jump', cord=(screen_width // 2 - 50, screen_height // 2 - 50), n=30, scr=screen)
    pygame.display.update()
    sleep(0.5)

    pygame.draw.rect(screen, BLACK, (0, 0, screen_width, screen_height))
    pr_text("LET'S GO", cord=(screen_width // 2 - 50, screen_height // 2 - 50), n=35, scr=screen)
    pygame.display.update()
    sleep(1)
